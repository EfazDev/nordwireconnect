...
pyinstaller --hidden-import PyKits -i "resources/app_icon.ico" --add-data "resources;resources" --add-data "installer;installer" --argv-emulation --clean -n NordWireConnectInstaller --onefile Installer.py
